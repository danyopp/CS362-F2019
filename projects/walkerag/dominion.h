...
int cardMinion(int currentPlayer, struct gameState *state, int handPos, int choice1, int choice2);
int cardAmbassador(int currentPlayer, struct gameState *state, int handPos, int choice1, int choice2);
int cardTribute(int currentPlayer, int nextPlayer, int *tributeRevealedCards, struct gameState *state, int handPos, int choice1, int choice2);
int cardMine(int currentPlayer, struct gameState *state, int handPos, int choice1, int choice2);
