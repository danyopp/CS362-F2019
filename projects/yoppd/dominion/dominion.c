...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
        return mineEffect(choice1, choice2, state, handPos, currentPlayer);
    ...
    case minion:
        return minionEffect( choice1, choice2, state, handPos, currentPlayer);
    ...
    case tribute:
      return tributeEffect( state, nextPlayer, currentPlayer );

    case ambassador:
      return ambassadorEffect( currentPlayer, choice1, choice2, state, handPos);
...
//Add 1 buy, Discard an estate for +4 treasure or gain an estate
...
// plus 1 action; choose 1: + 2 treasure or discard hand and draw 4 cards/everyone else with 5+ cards discards and draws 4 cards 
...
//nextplayer reveals and discards top two cards on deck. For each Action card (+ 2 actions), for each treasure card(+2 treasure), for each victory card(+2 cards)
...
//Trash a treasure, gain a treasure costing +3 more 
